...
import {PageBody, BtnContain, BtnSubmit, TitlePage, FormTitle, FormComplete, FormDiv, SubTitleList} from '../../../styles/Subpages/subpagesStyles';
    ...
    <PageBody>
      ...
      <div>
        ...
        <FormComplete>
          ...
          <BtnContain>
            <BtnSubmit type="submit"><i className="bi bi-search"></i>Buscar Cliente</BtnSubmit>
          </BtnContain>
          <br/>
          <hr />
          <SubTitleList>
